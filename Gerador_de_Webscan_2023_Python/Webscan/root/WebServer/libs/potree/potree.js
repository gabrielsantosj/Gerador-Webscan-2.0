let comment_coordinate;
let comments_tool_active = false;
let annotation_loaded =  false;
let current_cloud_coordinate = null;
	...
	onMouseUp (e) {
		...
		if (this.drag) {
			...
			if(clicked){
				...
				//console.log("click"); /* CLICK TO SET COMMENT POSITION */
				/*
...
Potree.Measure = class Measure extends THREE.Object3D {
	...
	setMarker (index, point) {
		...
		this.dispatchEvent(event);
		this.update();
		comment_coordinate = event.position;
	}
