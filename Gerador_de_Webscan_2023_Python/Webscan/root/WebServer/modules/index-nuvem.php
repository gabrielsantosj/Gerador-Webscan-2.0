...
<head>
	...
	<style type="text/css">
        *{margin:0;padding:0;overflow:hidden;}
	    ...
	    .close_f { position: absolute; padding:5px;float: right; right: 5px; top: 0px; color: #fff; z-index:999; font-family: Arial; cursor: pointer; font-size: 14px; background: #000; }
...
<body>
    ...
    <script>
        ...
        $(function(){
			setTimeout(updateTumbnail, 5000);
